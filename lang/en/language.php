...
$LANG['To'] = 'To';
$LANG['Mail has been deleted from queue'] = 'Mail has been deleted from queue';
$LANG['List has been added to queue'] = 'List has been added to queue';
$LANG['Send mail to list'] = 'Send mail to list';
$LANG['This mail is in queue and will be sent to: '] = 'This mail is in queue and will be sent to: ';
$LANG['This mail has been sent to: '] = 'This mail has been sent to: ';
$LANG['Delete from queue'] = 'Delete from queue';
...
$LANG['The name of the list'] = 'The name of the list';
